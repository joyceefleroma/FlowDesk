...
export const LandingFooter = () => {
  return (
    <footer className="border-t border-white/10 bg-[#060304]/95 backdrop-blur-2xl py-12 px-4 sm:px-8 lg:px-12 relative z-10 text-xs text-white/50">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        {/* Brand */}
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-red-500 via-amber-500 to-yellow-300 flex items-center justify-center text-white shadow-glow-yellow">
