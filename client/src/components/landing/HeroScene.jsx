...
export const HeroScene = () => {
  return (
    <section id="hero" className="min-h-[calc(100vh-80px)] pt-36 pb-24 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto flex items-center relative z-10">
      {/* Left-Aligned Hero Content Box */}
      <div className="max-w-[640px] flex flex-col items-start text-left">
        {/* Pill Badge with Red & Amber Glow */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-red-500/15 via-amber-500/15 to-white/10 border border-amber-500/30 text-amber-300 text-xs font-bold mb-6 shadow-glow-yellow backdrop-blur-xl animate-in fade-in duration-700">
        ...
        {/* Hero Description */}
        <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-[540px] mt-6 leading-relaxed font-normal">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-8 w-full sm:w-auto">
          <Link to="/register" className="w-full sm:w-auto">
            <Button variant="glow" size="lg" icon={Flame} className="w-full sm:w-auto text-base px-8 py-3.5 font-bold h-12 shadow-glow-red">
              Get Started Free
            </Button>
          </Link>
        ...
        {/* Quick Value Metrics */}
        <div className="flex flex-wrap items-center gap-6 sm:gap-8 mt-10 pt-6 border-t border-white/10 text-xs text-white/60">
